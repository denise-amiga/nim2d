...
proc meshVertex*(x, y: float, u = 0.0, v = 0.0,
                 color: Color = (255'u8, 255'u8, 255'u8, 255'u8)): Vertex =
  Vertex(x: x.float32, y: y.float32, u: u.float32, v: v.float32,
         r: color.r.float32 / 255, g: color.g.float32 / 255,
         b: color.b.float32 / 255, a: color.a.float32 / 255)
