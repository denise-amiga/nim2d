...
let n2d =
  newNim2d("nim2d - noise", 120, 80, W.cint, H.cint, (12'u8, 12'u8, 16'u8, 255'u8))
...
let curve =
  newBezierCurve(@[(40.0, 540.0), (220.0, 360.0), (380.0, 580.0), (560.0, 380.0)])
...
n2d.draw = proc(nim2d: Nim2d) =
  ...
  for gy in 0 ..< rows:
    for gx in 0 ..< cols:
      ...
      nim2d.rectangle(
        (gx * cell).float, (gy * cell).float, cell.float, cell.float, filled = true
      )
  ...
  nim2d.print(
    "perlin noise, a concave star (ear-clipped fill) and a bezier curve", 14, 12
  )
