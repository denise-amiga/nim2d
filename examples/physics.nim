...
let n2d =
  newNim2d("nim2d - physics", 120, 80, W.cint, H.cint, (18'u8, 20'u8, 30'u8, 255'u8))
...
n2d.load = proc(nim2d: Nim2d) =
  for i in 0 ..< 12:
    spawn(random(120.0, W - 120.0), random(40.0, 220.0))
...
n2d.keydown = proc(nim2d: Nim2d, sc: Key) =
  if sc == Key.escape:
    ...
    for i in 0 ..< 6:
      spawn(random(120.0, W - 120.0), random(40.0, 120.0))
...
n2d.draw = proc(nim2d: Nim2d) =
  ...
  nim2d.print(
    "physics: " & $objs.len & " bodies   click/space to drop   R clears", 20, 16
  )
